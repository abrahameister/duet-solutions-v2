    ...
    return (
        <>
            ...
            <div className="md:hidden fixed bottom-0 left-0 right-0 p-4 bg-bg/95 backdrop-blur-md border-t border-border shadow-[0_-10px_40px_rgba(0,0,0,0.5)] z-50 flex items-center gap-4">
                ...
                <a
                    href="https://wa.me/56973858191?text=Hola,%20vengo%20de%20su%20sitio%20web.%20Me%20gustar%C3%ADa%20agendar%20un%20an%C3%A1lisis%20para%20mi%20empresa."
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-14 h-14 bg-[#25D366] rounded-xl text-white shadow-md active:scale-95 transition-transform flex items-center justify-center shrink-0"
                >
