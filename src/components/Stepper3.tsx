                    ...
                    <div className="space-y-16 relative">
                        {steps.map((step, idx) => (
                            <div key={idx} className="process-step flex items-start gap-8 md:gap-12 relative z-10">
                                {/* Number / Icon */}
                                <div className="flex-shrink-0 w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-white border border-border shadow-sm flex flex-col items-center justify-center relative bg-clip-padding">
                                    <span className="text-sm font-bold text-accentPrimary mb-1">Paso {step.num}</span>
                                    <div className="text-surface">{step.icon}</div>
                                </div>
